...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        affine_relu_forward_out_2, cache_forward_2 = affine_relu_forward(conv_forward_out_1, self.params['W2'], self.params['b2'])
        #affine_relu_2, cache_relu_2 = relu_forward(affine_forward_out_2)
        scores, cache_forward_3 = affine_forward(affine_relu_forward_out_2, self.params['W3'], self.params['b3'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dX2, grads['W2'], grads['b2'] = affine_relu_backward(dX3, cache_forward_2)
